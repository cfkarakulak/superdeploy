...
def generate_project_secrets(
    ...
    **kwargs,  # postgres_password, rabbitmq_password for backward compat
        ...
        for addon_type in sorted(addons_by_type.keys()):
            ...
            for instance_name, instance_data in sorted(
                ...
                if addon_type == "postgres":
                    ...
                    # HOST will be auto-filled with VM internal IP by SecretIPUpdater
                    yml_lines.append("        HOST: ''")
    ...
    yml_lines.append("#")
    yml_lines.append("#     RABBITMQ_HOST: addons.queues.primary.host")
    yml_lines.append("#     RABBITMQ_PORT: addons.queues.primary.port")
    yml_lines.append("#     RABBITMQ_USER: addons.queues.primary.user")
    yml_lines.append("#     RABBITMQ_PASSWORD: addons.queues.primary.password")
    yml_lines.append("#")
