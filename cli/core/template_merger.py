...
class TemplateMerger:
    ...
    def merge_env(self, addons: Dict[str, Addon], project_config: dict) -> str:
        """
        Merge environment variables from all addons for workflow generation.

        NOTE: Legacy function - new projects use secrets.yml instead.
        ...
        Returns:
            String containing environment variable definitions
        """
        # Extract project name from nested structure
        project_info = project_config.get("project", {})
        if isinstance(project_info, dict):
        ...
        lines = [
            "# SuperDeploy - Environment Variables Reference",
            f"# Project: {project_name}",
            "# Auto-generated by: superdeploy generate",
            "#",
            "# NOTE: New projects use secrets.yml - this is for legacy/reference only",
            "",
        ]
