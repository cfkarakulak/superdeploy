...
""".format(**project_secrets)
        ...
        console.print(f"[green]✅ Orchestrator secrets saved to: shared/orchestrator/.env[/green]")
...
"""
        ...
        console.print(f"[green]✅ Shared config created: shared/config/.env[/green]")
        console.print("[yellow]⚠️  Please edit shared/config/.env and fill in Docker credentials[/yellow]")
    else:
        console.print("[dim]✓ Using existing shared config from config/.env[/dim]")
...
def down(yes):
    ...
    if not terraform_state_dir.exists():
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                console.print("[yellow]⚠️  Terraform destroy had issues, cleaning manually...[/yellow]")
    ...
    if True:
        ...
        if result.returncode == 0:
            ...
            console.print(f"[yellow]  ⚠ Subnet deletion: {result.stderr.strip()[:100]}[/yellow]")
        ...
        if result.returncode == 0:
            ...
            console.print(f"[yellow]  ⚠ Network deletion: {result.stderr.strip()[:100]}[/yellow]")
    ...
    console.print("[green]✅ Config state reset[/green]")
