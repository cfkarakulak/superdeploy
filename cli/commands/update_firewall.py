...
def update_firewall(project):
    ...
    try:
        ...
        console.print(f"[dim]✓ Loaded config: {projects_dir / project}/project.yml[/dim]")
    ...
    console.print(f"[dim]✓ Generated tfvars with updated ports[/dim]")
    ...
    try:
        ...
        console.print(f"  • Updated allowed ports: {', '.join(project_config.to_terraform_vars()['app_ports'])}")
