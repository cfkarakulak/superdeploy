  ...
  return (
    <div>
      ...
      <PageHeader
        breadcrumb={{
          label: "Metrics",
          href: `/project/${projectName}/app/${appName}/metrics`
        }}
        title="Performance Metrics"
        description={`Real-time performance and resource utilization data for ${appName}`}
      />
        ...
        <div className="flex flex-col items-center justify-center py-20">
          <div className="text-center">
            ...
            <p className="text-[15px] text-[#8b8b8b]">
              Performance metrics and monitoring will be available soon.
            </p>
          </div>
        </div>
      </div>
